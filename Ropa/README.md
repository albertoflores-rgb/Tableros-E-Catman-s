...
Carpeta para tableros, documentos y recursos relacionados con Ropa.
...
### `tablero_insights_com_apparel/`
Tablero **Insights .com Ropa** (categorias 21,22,23,26,33,34,36,63,66,67). Owner: Dani.
...
python run_team_pipeline.py apparel
```
