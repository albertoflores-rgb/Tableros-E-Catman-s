@echo off
REM ============================================================
REM DESCARGAR_Y_ABRIR_TABLERO.bat -- Ropa
REM
...
echo ============================================================
echo   Tablero Insights .com Ropa
echo ============================================================
echo.

REM --- Caso A: el repo ya esta completo junto a este .bat -------
if exist "%~dp0tablero_insights_com_apparel\tablero_insights_com_apparel.html" (
    echo Repo ya extraido junto a este archivo -- abriendo directo,
    echo sin necesidad de descargar nada.
    set "HTML_FILE=%~dp0tablero_insights_com_apparel\tablero_insights_com_apparel.html"
    goto :abrir
)
...
if errorlevel 1 (
    ...
    echo         adentro de la carpeta "Ropa" ya extraida.
    pause
    exit /b 1
)
...
for /r "%DEST_DIR%" %%F in (*.html) do (
    if /i "%%~nxF"=="tablero_insights_com_apparel.html" set "HTML_FILE=%%F"
)

if not defined HTML_FILE (
    echo [ERROR] No se encontro tablero_insights_com_apparel.html dentro del ZIP descargado.
