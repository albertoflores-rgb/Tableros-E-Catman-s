-- ============================================================
-- query_item_total_tecnologia.sql
...
-- con @cat_filter = [3, 5, 6, 15, 29, 31, 32, 60, 61, 71, 81, 98]).
-- ============================================================
...
-- Filtro de categorias: Tecnologia (Valeria) -- version LITERAL,
...
WHERE T2.Cat_Nbr IN (3, 5, 6, 15, 29, 31, 32, 60, 61, 71, 81, 98)
