...
const EXP_LABELS = {
  ...
  Status: 'Status', Semaforo_OH: 'Inventario',
  Top_L7D_Cat: 'Top L7D (Cat)',
  Inv_Pzas_Total: 'Inv. Pzas Total', Inv_MXN_Total: 'Inv. Valor $',
  Club_con_Inventario: 'Tiendas con Inv.', Precio_Venta: 'Precio',
  Inventario_DSV: 'Inventario DSV', DSV_Proveedor: 'Proveedor DSV', DSV_Costo: 'Costo DSV',
...
const EXP_TOTALS_TYPE = {
  ...
  // En_Parrilla/Promo_Vigente no aplican aqui (equipo sin parrilla/promos todavia).
};
