...
Carpeta para tableros, documentos y recursos relacionados con Impulso.
...
### `tablero_insights_com_impulso/`
Tablero **Insights .com Impulso** (categorias 1,19,28,40,48,52,55,58). Owner: Kevin.
...
https://puppy.walmart.com/sharing/a0f07dn/tablero-insights-com-impulso
...
python run_team_pipeline.py impulso
```
