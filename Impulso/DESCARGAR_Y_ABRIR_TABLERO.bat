@echo off
REM ============================================================
REM DESCARGAR_Y_ABRIR_TABLERO.bat -- Impulso
REM
...
echo ============================================================
echo   Tablero Insights .com Impulso
echo ============================================================
echo.

REM --- Caso A: el repo ya esta completo junto a este .bat -------
if exist "%~dp0tablero_insights_com_impulso\tablero_insights_com_impulso.html" (
    echo Repo ya extraido junto a este archivo -- abriendo directo,
    echo sin necesidad de descargar nada.
    set "HTML_FILE=%~dp0tablero_insights_com_impulso\tablero_insights_com_impulso.html"
    goto :abrir
)
...
if errorlevel 1 (
    ...
    echo         adentro de la carpeta "Impulso" ya extraida.
    pause
    exit /b 1
)
...
for /r "%DEST_DIR%" %%F in (*.html) do (
    if /i "%%~nxF"=="tablero_insights_com_impulso.html" set "HTML_FILE=%%F"
)

if not defined HTML_FILE (
    echo [ERROR] No se encontro tablero_insights_com_impulso.html dentro del ZIP descargado.
