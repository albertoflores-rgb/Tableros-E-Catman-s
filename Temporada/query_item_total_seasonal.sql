-- ============================================================
-- query_item_total_seasonal.sql
-- Departamento : Seasonal
-- Owner        : Nat / Dani
...
-- con @cat_filter = [7, 9, 10, 69, 12, 11, 16, 14, 18, 17, 51, 78, 85, 83, 92, 50, 94]).
-- ============================================================
...
-- Filtro de categorias: Seasonal (Nat / Dani) -- version LITERAL,
...
WHERE T2.Cat_Nbr IN (7, 9, 10, 69, 12, 11, 16, 14, 18, 17, 51, 78, 85, 83, 92, 50, 94)
