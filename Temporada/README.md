...
### `tablero_insights_com_seasonal/`
Tablero **Insights .com Temporada** (categorias 7,9,10,69,12,11,16,14,18,17,51,78,85,83,92,50,94). Owner: Nat / Dani.
...
https://puppy.walmart.com/sharing/a0f07dn/tablero-insights-com-seasonal
...
python run_team_pipeline.py seasonal
```
