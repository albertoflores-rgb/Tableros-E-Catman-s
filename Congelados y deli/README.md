...
### `tablero_insights_com_perecederos/`
Tablero **Insights .com Congelados y deli** (categorias 42,44,38,56,72,77,76,39,57,59,91,79). Owner: Pacheco.
...
https://puppy.walmart.com/sharing/a0f07dn/tablero-insights-com-perecederos
...
python run_team_pipeline.py perecederos
```
