-- ============================================================
-- query_item_total_perecederos.sql
-- Departamento : Perecederos - Deli Fresh y Congelados
-- Owner        : Pacheco
...
-- con @cat_filter = [42, 44, 38, 56, 72, 77, 76, 39, 57, 59, 91, 79]).
-- ============================================================
...
-- Filtro de categorias: Perecederos - Deli Fresh y Congelados (Pacheco) -- version LITERAL,
...
WHERE T2.Cat_Nbr IN (42, 44, 38, 56, 72, 77, 76, 39, 57, 59, 91, 79)
