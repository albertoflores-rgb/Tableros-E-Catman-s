@echo off
REM ============================================================
REM DESCARGAR_Y_ABRIR_TABLERO.bat -- Congelados y deli
REM
...
echo ============================================================
echo   Tablero Insights .com Congelados y deli
echo ============================================================
echo.

REM --- Caso A: el repo ya esta completo junto a este .bat -------
if exist "%~dp0tablero_insights_com_perecederos\tablero_insights_com_perecederos.html" (
    echo Repo ya extraido junto a este archivo -- abriendo directo,
    echo sin necesidad de descargar nada.
    set "HTML_FILE=%~dp0tablero_insights_com_perecederos\tablero_insights_com_perecederos.html"
    goto :abrir
)
...
if errorlevel 1 (
    ...
    echo         adentro de la carpeta "Congelados y deli" ya extraida.
    pause
    exit /b 1
)
...
for /r "%DEST_DIR%" %%F in (*.html) do (
    if /i "%%~nxF"=="tablero_insights_com_perecederos.html" set "HTML_FILE=%%F"
)

if not defined HTML_FILE (
    echo [ERROR] No se encontro tablero_insights_com_perecederos.html dentro del ZIP descargado.
